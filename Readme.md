...
locations and can accommodate user specified variable pumping rates. The
...
serve rather as convenient ways for the user to create depletion maps
and estimates without writing the methods themselves. Please see within
each folder more detailed documentation, references, and examples.
Documentation of variables, assumptions, and references are mostly the
same within each folder, as the functions are reverses of eathother.
